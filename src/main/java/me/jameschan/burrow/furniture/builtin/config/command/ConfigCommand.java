...
@CommandLine.Command(name = "config", description = "Retrieve or update configuration.")
public class ConfigCommand extends Command {
  @CommandLine.Parameters(index = "0", description = "The configuration key", defaultValue = "")
  private String key;

  @CommandLine.Parameters(index = "1", description = "The configuration value", defaultValue = "")
